...
export default function Game({ teamList }: TeamProps) {
  ...
  async function handleRegister(event: FormEvent){
    ...
    try {
      if (day === '' || numberGame === '' || match === '' || homeTeam === '' || awayTeam === '' || location === '') {
      ...
      router.push
      (`/addGame?numberGame=${numberGame}&day=${day}&id=${createdGameId}&homeTeam=${homeTeam}&awayTeam=${awayTeam}&match=${match}&location=${location}`);
      setId('');
      setDay('');
      setNumberGame('');
      setHomeTeam('');
